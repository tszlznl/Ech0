    ...
    "paths": {
        ...
        "/agent/settings/test": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "测试 Ech0 Copilot 连接失败",
                        "schema": {
                            "$ref": "#/definitions/handler.Response"
                        }
                    }
        ...
        "/auth/exchange": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "包含 access_token 和 expires_in"
                    },
                    "400": {
        ...
        "/embedding/settings": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "新的 Embedding 设置",
                        "name": "settings",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.EmbeddingSettingDto"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "更新 Embedding 设置失败",
                        "schema": {
                            "$ref": "#/definitions/handler.Response"
                        }
                    }
        ...
        "/oauth/info": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "OAuth2 提供商，默认 github",
                        "name": "provider",
                        "in": "query"
                    }
                ],
        ...
        "/oauth/{provider}/bind": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "OAuth2 提供商 (github/google/qq/custom)",
                        "name": "provider",
                        "in": "path",
                        "required": true
                    },
        ...
        "/oauth/{provider}/callback": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "参数无效或回调处理失败",
                        "schema": {
                            "$ref": "#/definitions/handler.Response"
                        }
                    },
                    "302": {
                        "description": "重定向到前端 /auth?code=xxx"
                    }
                }
            }
        },
        "/oauth/{provider}/login": {
            "get": {
                ...
                "responses": {
                    ...
                    "302": {
                        "description": "重定向到 OAuth2 提供商授权页"
                    }
                }
            }
        },
        ...
        "/passkey/login/finish": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "包含 nonce 和 credential 的请求体",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.PasskeyFinishReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.PasskeyRegisterBeginReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/passkeys/{id}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Passkey 设备 ID (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.PasskeyUpdateDeviceNameReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.AgentSettingDto": {
            ...
            "properties": {
                ...
                "context_window": {
                    "description": "ContextWindow 是模型上下文窗口的 token 数（0=未配置，按保守默认处理）；用于区间聚合的取数预算。",
                    "type": "integer"
                },
                "enable": {
                ...
                "multimodal": {
                    "description": "多模态支持：检索命中带图 Echo 时把配图递给模型（需模型支持视觉）",
                    "type": "boolean"
                },
                "prompt": {
        ...
        "model.PasskeyFinishReq": {
            "type": "object"
        },
        "model.PasskeyRegisterBeginReq": {
            "type": "object",
            "properties": {
                "device_name": {
                    "type": "string"
        ...
        "model.PasskeyUpdateDeviceNameReq": {
            "type": "object",
            "required": [
                "device_name"
            ],
