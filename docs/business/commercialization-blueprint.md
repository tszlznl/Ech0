...
> ⚠️ **合规修正（后写，优先级高于本节）**：本节按「一个全球市场」推演。经 [`compliance-reality-check.md`](./compliance-reality-check.md) 核实法规后，结论变了：
> **A（Cloud 托管）在中国大陆不可行** —— 托管 UGC 并收费需要公司主体 + 100 万注册资本 + 经营性 ICP 许可证 + 安全评估 + 实名认证 + 内容审核连带责任，首年合规成本约为年毛利的 10 倍。
> 修正后的分工：**国内只做 C/D（授权、支持、代客部署），Cloud 只面向海外**。下文的四条腿仍然成立，但 A、B 请默认加上「仅海外」前缀。
...
> 📄 **本节只讲开源许可与基础行政事项。真正会否决方案的是监管合规 —— 已单独展开为 [`compliance-reality-check.md`](./compliance-reality-check.md)，含法规出处、成本量级与国内/海外对照。读完那篇再回来看本节。**
